...
export class MessageControllerService {
     ...
     */
    public createMessage(body: MessageDTO, observe?: 'body', reportProgress?: boolean): Observable<MessageDTO>;
    public createMessage(body: MessageDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<MessageDTO>>;
    public createMessage(body: MessageDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<MessageDTO>>;
    public createMessage(body: MessageDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
