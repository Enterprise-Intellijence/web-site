...
export class ReviewControllerService {
     ...
     */
    public allReview(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public allReview(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public allReview(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public allReview(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('get',`${this.basePath}/api/v1/reviews`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createReview(body: ReviewDTO, observe?: 'body', reportProgress?: boolean): Observable<ReviewDTO>;
    public createReview(body: ReviewDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ReviewDTO>>;
    public createReview(body: ReviewDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ReviewDTO>>;
    public createReview(body: ReviewDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
