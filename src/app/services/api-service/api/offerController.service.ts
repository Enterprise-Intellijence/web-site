...
export class OfferControllerService {
     ...
     */
    public createOffer(body: OfferDTO, observe?: 'body', reportProgress?: boolean): Observable<OfferDTO>;
    public createOffer(body: OfferDTO, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<OfferDTO>>;
    public createOffer(body: OfferDTO, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<OfferDTO>>;
    public createOffer(body: OfferDTO, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
