...
export class UserControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public userHoliday(id: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public userHoliday(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public userHoliday(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public userHoliday(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling userHoliday.');
        }
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/api/v1/users/userHoliday`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
